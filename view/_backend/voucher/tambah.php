<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="<?=base_url?>admin/voucher.php?aksi=tambah&proses=add" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <input type="text" id="rupiah1" class="form-control col-md-7" name="voucher_harga"
                                    required>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-md-4">Kadaluarsa</label>
                                <input type="date" id="inputEmail" class="form-control col-md-7" name="voucher_expired" required value="<?=date('Y-m-d')?>">
                            </div>
                        </div>
                    </div>
