<div class="row">
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <form action="<?=base_url?>admin/<?=$data['url']?>.php?aksi=edit&proses=update&id=<?=$data['value']->users_id?>" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <input type="text" id="inputNDepan" class="form-control col-md-7" name="users_nama"
                                    required value="<?=$data['value']->users_nama?>">
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail" class="col-md-4">Alamat Surel</label>
                                <input type="text" id="inputEmail" class="form-control col-md-7" name="email" required value="<?=$data['value']->email?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <select name="role_id" class="form-control col-md-7">
                                    ...
                                    <option value="<?=$i?>" <?=($data['value']->role_id == $i)?'selected':''?>><?=$arr[$i]?></option>
                                    <?php } ?>
                                </select>
